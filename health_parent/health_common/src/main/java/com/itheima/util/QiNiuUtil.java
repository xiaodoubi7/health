...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "qst6BMXjcjHPeOfVU_SaGWAy1GAAAlqdDVqHkk8W";
    private static final String SECRETKEY = "qmxO-PKgZgVZPf0PNwtSrYNybXpaMt8NaQwJcC-E";
    private static final String BUCKET = "healthmodel";
    public static final String DOMAIN = "pyc5g90el.bkt.clouddn.com";
