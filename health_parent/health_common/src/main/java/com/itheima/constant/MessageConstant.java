...
public interface MessageConstant {
    ...
    static final String GET_ALLUSER_FAILURE= "查询用户信息失败";
    static final String GET_ALLUSER_SUCCESS= "查询用户信息成功";
    static final String UPDATE_USER_SUCCESS= "修改用户信息成功";
    static final String UPDATE_USER_FAILURE= "修改用户信息失败";
    static final String DELETE_USER_FAILURE= "删除用户信息失败";
    static final String DELETE_USER_SUCCESS= "删除用户信息成功";
    static final String ADD_USER_SUCCESS= "增加用户信息成功";
    static final String ADD_USER_FAILURE= "增加用户信息失败";
    static final String GET_ALLROLE_FAILURE= "查询角色信息失败";
    static final String GET_ALLROLE_SUCCESS= "查询角色信息成功";
    static final String UPDATE_ROLE_SUCCESS= "修改角色信息成功";
    static final String UPDATE_ROLE_FAILURE= "修改角色信息失败";
    static final String DELETE_ROLE_FAILURE= "删除角色信息失败";
    static final String DELETE_ROLE_SUCCESS= "删除角色信息成功";
    static final String ADD_ROLE_SUCCESS= "增加角色信息成功";
    static final String ADD_ROLE_FAILURE= "增加角色信息失败";
    static final String CHECK_USERNAME_SECCESS= "用户名可用";
    static final String CHECK_USERNAME_FAILURE= "用户名已存在";
    static final String GET_PERMISSION_SUCCESS= "查询权限信息成功";
    static final String CHECK_KEYWORD_SUCCESS= "角色关键字可用";
    static final String CHECK_KEYWORD_FAILURE= "角色关键字已被占用";
    static final String CHECK_USERNAME_NULL= "用户名不能为空";
    static final String CHECK_KEYWORD_NULL= "角色关键字不能为空";
    static final String CHECK_ROLE_NULL= "角色被引用,不能删除";
    static final String HEALTH_MOBILE_PACKAGES = "health_mobile_packages";
}
